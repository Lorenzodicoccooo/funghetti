...
<head>
	...
	<link rel="stylesheet" type="text/css" href="style203.css">
...
<audio id="audio">
    ...
    <a onclick="stopFrancesca()"><img src="../src/vittoriano/stop.png" width="7%"></a>
        ...
        <br>
        <br>
		<h1 class="titolo">Colonia Vittorio Emanuele</h1>
		<br>
		<center> <img id="foto" src="../photos/photo-12.png" width="75%" class="foto"> <br><br><br><br></center>
...
function cambiaFoto(){
	setTimeout(function(){
		document.getElementById("foto").src="../photos/vittoriano11.png";
		setTimeout(function(){
			document.getElementById("foto").src="../photos/vittoriano12.png";
			setTimeout(function(){
				document.getElementById("foto").src="../photos/vittoriano13.png";
				setTimeout(function(){
					document.getElementById("foto").src="../photos/vittoriano14.png";
					cambiaFoto();
				},4000);
			},4000);
		},4000);
